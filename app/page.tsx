  ...
  return (
    <main className="bg-[#0c0c0c] min-h-screen ">
      ...
      <div className="text-center text-2xl font-garamond text-white/[.4] italic px-20 pt-10">
          <p>"{weekly.scriptureVerse}"</p>
          <p className=" text-center pt-6 text-white/[.18] font-cinzel text-sm tracking-widest">{weekly.scriptureBook}{weekly.scriptureVerse}</p>
      </div>
        ...
        {/*Middle Column*/}
          <div className="px-10 pb-10 mt-10">
            ...
            <div className="w-full h-70 border border-white/[.40] relative shadow-[0_0_25px_rgba(63,104,53,0.5)]">
              <Image src={weekly.discussion.image} fill alt="discussion" className="object-cover object-top " />
            </div>
            ...
            <div className="flex flex-row tracking-widest">
              <p className="text-sm text-[rgba(63,104,53,0.6)] font-cinzel pt-5">{weekly.discussion.replies} Replies so far</p>
              <p className="text-sm text-white/[.22] font-cinzel pt-5 pl-5"> {weekly.discussion.closes}</p>
            </div> 
